...
def write_health(root, latest):
    ...
    observations_html = ('<h2 id="source-checks">各信源最近一次实际检查</h2><p>各源最近检查时间与结果。'
                         '</p>'
