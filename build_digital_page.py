...
<div class="wrap">
  ...
  <div class="keyword-summary"><b>关键词筛选</b>：强数字信号 {core_n} · 技术信号 {tech_n} · 语境信号 {ext_n}；</div>
  ...
  <div class="method">
    ...
    <ul>
      ...
      <li><b>日期</b>：按原文发布日期统计；摘编条目采用来源页日期。</li>
...
fetch(DATA_URL,{{cache:'no-store'}}).then(function(r){{ return r.json(); }}).then(function(data){{
  init(data);
}}).catch(function(e){{
